...
<head>
    ...
    <link href="http://resource.trancyboy.com/admin/css/animate.css" rel="stylesheet">
...
<!-- 全局js -->
<script src="http://resource.trancyboy.com/admin/js/jquery.min.js?v=2.1.4"></script>
<script src="http://resource.trancyboy.com/admin/js/bootstrap.min.js?v=3.3.6"></script>
<script src="http://resource.trancyboy.com/admin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="http://resource.trancyboy.com/admin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="http://resource.trancyboy.com/admin/js/plugins/layer/layer.min.js"></script>
<!-- 自定义js -->
<script src="http://resource.trancyboy.com/admin/js/hAdmin.js?v=4.1.0"></script>
<script type="text/javascript" src="http://resource.trancyboy.com/admin/js/index.js"></script>
<!-- 第三方插件 -->
<script src="http://resource.trancyboy.com/admin/js/plugins/pace/pace.min.js"></script>
