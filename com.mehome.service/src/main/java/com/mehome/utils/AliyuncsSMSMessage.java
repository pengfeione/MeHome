 ...
 */
public class AliyuncsSMSMessage {
    @Autowired
    public AliyuncsProperties aliyuncsProperties;

    @Autowired
    public AliyuncsSMSTemp aliyuncsSMSTemp;

        public  void Send(AliyuncsSMSMessage  aliyuncsSMSMessage) {
            /**
             * Step 1. 获取主题引用
             */
            CloudAccount account = new CloudAccount(aliyuncsProperties.getAccessid(), aliyuncsProperties.getAccessKey(), aliyuncsProperties.getOss_endpoint());
