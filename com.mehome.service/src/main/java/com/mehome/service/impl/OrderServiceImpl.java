...
public class OrderServiceImpl implements IOrderService {
    ...
    @Autowired
    private ProductRelationWelfareDao productRalationWelfareDAO;
    @Autowired
        ...
        if (house != null && house.getProductId() != null) {
            ...
            if (product != null) {
                if (product.getIsWelfare() && userCompanyId != null) {
                    // 有企业福利
                    List<ProductRelationWelfare> ralationList = productRalationWelfareDAO.selectByProductId(product.getProductId());
